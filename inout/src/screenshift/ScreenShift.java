...
public class ScreenShift {
    ...
    final static MyScreenDeviceArray screens = new MyScreenDeviceArray();
    static MousePositionObject mouse;
...
//this method executes the move commands based on iput of the user
     ...
     * @throws AWTException
     */
    public static void doTheMoves(MyScreenDeviceArray screens) throws AWTException {
...
//calculates and moves to the next screen
    private static void moveToNextScreen() throws AWTException {
        ...
        MouseMover.move(next_screen, mov_rel_x, mov_rel_y);
        if (log == true) {
