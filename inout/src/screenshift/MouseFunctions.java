...
public class MouseFunctions {
    ...
    public static int[] getMousePositionOnThisScreen() {
        MyScreenDeviceArray screens = new MyScreenDeviceArray();
    ...
    public static void shiftScreen() throws AWTException {
        final MyScreenDeviceArray screens = new MyScreenDeviceArray();
        ScreenShift.doTheMoves(screens);
    }
